...
public class ServerConnector2 implements ServerConnector {
    ...
    public boolean update(ServerInfo info) {
        try {
            ...
            info.setMotd(response.getDescription().getText());
            return true;
    ...
    public StatusResponse fetchData(ServerInfo info) throws IOException {
